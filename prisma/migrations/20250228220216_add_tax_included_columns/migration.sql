...
INSERT INTO "new_TransactionItem" ("barcode", "id", "itemId", "price", "quantity", "title", "transactionId", "voided") SELECT "barcode", "id", "itemId", "price", "quantity", "title", "transactionId", "voided" FROM "TransactionItem";
