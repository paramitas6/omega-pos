...
import { Package, BarChart, ArrowRight, Zap, Rocket, Smile } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-12 relative z-10">
          ...
          <div className="bg-white p-8 rounded-3xl shadow-2xl border-2 border-blue-100 hover:border-purple-300 transition-all duration-500 hover:scale-105 hover:-rotate-6 group relative overflow-hidden">
            ...
            <p className="text-slate-600 mb-8 leading-relaxed text-xl">
              EZPZ RTZ inventory management. Get tilted with a few clicks. <Smile className="inline-block" />
            </p>
            <a
              href="/manager/items"
          ...
          {/* Sales Card */}
          <div className="bg-white p-8 rounded-3xl shadow-2xl border-2 border-blue-100 hover:border-green-300 transition-all duration-500 hover:scale-105 hover:rotate-3 group relative overflow-hidden"
            ...
            <p className="text-slate-600 mb-8 leading-relaxed text-xl">
              Numbers go brrrrrrrrr. <Rocket className="inline-block" /> Dive into the analytics suite for more.
            </p>
            <a
              href="/manager/sales"
          ...
          {/* Stats Card */}
          <div className="bg-gradient-to-br from-purple-400 to-blue-500 p-8 rounded-3xl shadow-2xl text-white relative overflow-hidden col-span-1 md:col-span-2 xl:col-span-1 group"
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white/10 p-6 rounded-2xl backdrop-blur-sm hover:-skew-x-3 transition-transform">
                  <div className="text-lg opacity-90">Lo5w .9888 SSSSSSSSSSSSSSSSSSSSSSSSSS</div>
                  <div className="text-4xl font-bold">WRITTEN BY CHARLIE'S PAW</div>
                </div>
              </div>
            </div>
          </div>
